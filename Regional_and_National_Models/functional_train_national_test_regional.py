...
statics_train,statics_test = ([] for i in range(2))
X_train2, X_test, y_train2, y_test,X_2_train2,X_2_test  = train_test_split(featuressmall, labelssmall,countiessmall, test_size=0.2, shuffle = True)
X_train, X_test2, y_train, y_test2,X_2_train,X_2_test2  = train_test_split(featuresbig, labelsbig,countiesbig, test_size=0.2, shuffle = True)
...
df22.to_excel(excel_writer="natregstats.xlsx")

from google.colab import files
files.download("/content/natregstats.xlsx")
