...
X_train, X_test2, y_train, y_test2 = train_test_split(featuresSmall, labelsSmall, test_size=0.2, shuffle = True)
X_train2, X_test, y_train2, y_test = train_test_split(featuresBig, labelsBig, test_size=0.2, shuffle = True)
...
df22.to_excel(excel_writer="SeqStat.xlsx")
files.download("/content/SeqStat.xlsx")
